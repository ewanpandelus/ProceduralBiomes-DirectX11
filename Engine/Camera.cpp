...
void Camera::Update()
{
	...
	m_forward.x = sin(m_orientation.x * 3.1415f / 180.0f) * sin(m_orientation.y * 3.1415f / 180.0f);
	m_forward.y = cos(m_orientation.x * 3.1415f / 180.0f);
	m_forward.z = sin(m_orientation.x * 3.1415f / 180.0f) * cos(m_orientation.y * 3.1415f / 180.0f);
	m_forward.Normalize();
